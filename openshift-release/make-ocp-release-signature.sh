...
LABEL_STR='"release.openshift.io/verification-signatures": ""'
ANNOTATION_STR='"source-path": "'${LOCAL_REGISTRY_RELEASE_PATH}'", "release-version": "'${OCP_RELEASE}'", "source-registry": "'${LOCAL_REGISTRY}'", "source-image": "'${IMAGE}'"' # so labels can't have slashes in the key or value
