...
What's really nice about Harbor is they have this handy offline installer - grab the latest one from here: https://<your-domain>
...
TLS is outside the scope of this doc, you can read more and find steps on generating a self-signed cert here: https://<your-domain>

You could also use this awesome thing to roll your own PKI: https://<your-domain>
...
Additional configuration details and options can be found here: https://<your-domain>

The key configuration parameters to specify are:

```yaml
# The IP address or hostname to access admin UI and registry service.
# DO NOT use localhost or <ip-address>, because Harbor needs to be accessed by external clients.
...
proxy:
  ...
  no_proxy: localhost,.kemo.labs,.kemo.network,<ip-address>/14,<ip-address>,<ip-address>/16,<ip-address>/16
  components:
    - core
    - jobservice
    - trivy
